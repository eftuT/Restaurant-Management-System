...
<head>
    ...
    <title>Order - SEN'Q Restaurant</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .order-form .btn { width: 100%; margin-top: 20px; padding: 14px; border: none; border-radius: 10px; background: linear-gradient(135deg, #b45f2b, #8a471f); color: #fff; font-weight: 600; font-size: 16px; cursor: pointer; transition: 0.3s; }
        .order-form .btn:hover { transform: translateY(-2px); box-shadow: 0 10px 20px rgba(180,95,43,0.3); }
