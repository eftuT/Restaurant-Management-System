...
<div class="sidebar">
    <ul>
        ...
        <li><a href="tabledel.php" class="active"><i class="fa fa-trash"></i> <span>Delete Table</span></a></li>
...
<div class="main-content">
    <h2 style="margin-bottom:25px;"><i class="fa fa-trash"></i> Delete Table</h2>
    ...
    <div class="card">
        ...
        <form method="post">
            ...
            <button type="submit" name="del" class="btn-danger" onclick="return confirm('Are you sure you want to delete this table?')">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="table-card <?php echo $row['status'] == 'Available' ? 'available' : 'booked'; ?>">
                <div class="table-icon"><i class="fa fa-table"></i></div>
                <div class="table-id">#<?php echo $row['id']; ?></div>
